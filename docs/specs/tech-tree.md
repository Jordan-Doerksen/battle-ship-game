...
11 pts as tuned, and the C5 SONAR (9) and C6 AIR WING (13) branches landed after this spec.
C11 update, 2026-07-10: ORDNANCE grew ord7 RANGEKEEPER (+2). The full tree costs **65 points =
level 66** today; `config/tech.tres` is the authority.)*
